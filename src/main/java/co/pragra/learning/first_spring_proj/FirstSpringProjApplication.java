...
//        bm.print(bm);
        ...
        BMWM3 bmwm3 = context.getBean("bmwm3", BMWM3.class);
        bmwm3.print(bmwm3);
        order.show(bmwm3);
        System.out.println("order = " + order);
        System.out.println("result of show method is: " + order.show(bmwm3));
...
//        bmwm4.print(bmwm4);
        ...
        Employee emp4 = new Employee("amit", "mechanical", 101);
        Employee emp5 = new Employee("amit", "mechanical", 101);

        System.out.println("result of double equals");
        System.out.println(emp1 == emp2);
        System.out.println("result of equals method: " + emp1.equals(emp2));

        System.out.println("employee 4 hashcode is: " + emp4.hashCode());
        System.out.println("employee 5 hashcode is: " + emp5.hashCode());
        ...
        System.out.println("m.get(emp4) = " + m.get(emp4));
        System.out.println("m.get(emp5) = " + m.get(emp5));
